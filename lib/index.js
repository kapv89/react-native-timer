...
return this.contextTimers.get(ctx);}},{key:'setTimeout',value:function setTimeout()
...
_this2.contextTimer(ctx).clearTimeout(timeout);});}else 
...
ctx,name){
return this.contextTimers.has(ctx)&&this.contextTimer(ctx).timeoutExists(name);}},{key:'_timeoutExistsVanilla',value:function _timeoutExistsVanilla(


name){
return this.timeouts.has(name)||this.executedTimeouts.has(name);}},{key:'setInterval',value:function setInterval()
...
_this3.contextTimer(ctx).clearInterval(interval);});}else 
...
ctx,name){
return this.contextTimers.has(ctx)&&this.contextTimer(ctx).intervalExists(name);}},{key:'_intervalExistsVanilla',value:function _intervalExistsVanilla(
...
_this5.contextTimer(ctx).clearImmediate(immediate);});}else 
...
ctx,name){
return this.contextTimers.has(ctx)&&this.contextTimer(ctx).immediateExists(name);}},{key:'_immediateExistsVanilla',value:function _immediateExistsVanilla(


name){
return this.immediates.has(name)||this.executedImmediates.has(name);}},{key:'requestAnimationFrame',value:function requestAnimationFrame()
...
_this7.contextTimer(ctx).cancelAnimationFrame(animationFrame);});}else 
...
ctx,name){
return this.contextTimers.has(ctx)&&this.contextTimer(ctx).animationFrameExists(name);}},{key:'_animationFrameExistsVanilla',value:function _animationFrameExistsVanilla(


name){
return this.animationFrames.has(name)||this.executedAnimationFrames.has(name);}}]);return Timer;}();
